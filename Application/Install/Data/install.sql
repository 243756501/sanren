...
(1001, '_CONFIG_WEB_SITE_NAME', 0, '', 0, '', '', 1427339647, 1427339647, 1, 'OpenSNS v3开源社群系统', 0),
(1002, '_CONFIG_ICP', 0, '', 0, '', '', 1427339647, 1427339647, 1, '浙ICP备12042711号-5 Powered by OpenSNS', 0),
...
(235, '公告列表', 197, 0, 'Announce/announceList', 0, '', '公告管理', 0, '', ''),
(236, '发布公告', 197, 0, 'Announce/add', 0, '', '公告管理', 0, '', ''),
(237, '设置公告状态', 235, 0, 'Announce/setStatus', 1, '', '公告管理', 0, '', ''),
(238, '公告送达情况', 235, 0, 'Announce/arrive', 1, '', '公告管理', 0, '', ''),
(239, '会话列表', 74, 0, 'Message/messageSessionList', 0, '', '会话管理', 1, '', ''),
(240, '会话消息模板', 74, 0, 'Message/messageTplList', 0, '', '会话管理', 1, '', ''),
(241, '刷新会话列表', 74, 0, 'Message/sessionRefresh', 1, '', '', 1, '', ''),
(242, '刷新消息模板列表', 74, 0, 'Message/tplRefresh', 1, '', '', 1, '', ''),
(243, '计划任务列表',74,'0','admin/schedule/scheduleList','0','','计划任务','0','',''),
...
(253, '充值用户统计', 197, 0, 'Count/consumption', 0, '', '数据统计', 0, '', ''),
(254, '活跃用户统计', 197, 0, 'Count/active', 0, '', '数据统计', 0, '', ''),
(255, '设置活跃度绑定的行为', 197, 0, 'Count/setActiveAction', 1, '', '数据统计', 0, '', ''),
(256, '在线用户列表',197,'0','Count/nowUserList',0,'','数据统计',0,'',''),
(257, '下线在线用户',197,'0','Count/downUser',1,'','数据统计',0,'',''),
(258, '会话设置', 74, 0, 'Message/config', 0, '', '会话管理', 0, '', ''),
...
(263, '友情链接', 197, 0, 'SuperLinks/index', '0', '', '广告配置', '0', '', ''),
(264, '图片水印设置', 74, 0, 'Picture/config', 0, '', '图片管理', 1, '', ''),
(265, '上传水印图片', 264, 0, 'Picture/uploadWater', 1, '', '图片管理', 1, '', ''),
(266, '图片列表', 74, 0, 'Picture/pictureList', 0, '', '图片管理', 1, '', ''),
(267, '设置图片状态、删除图片', 266, 0, 'Picture/setStatus', 1, '', '图片管理', 1, '', ''),
(268,'敏感词列表', 113, 0, 'Sensitive/index', 0, '', '敏感词过滤', 0, '', ''),
(269,'敏感词设置', 113, 0, 'Sensitive/config', 0, '', '敏感词过滤', 0, '', ''),
(270,'批量添加', 113, 0, 'Sensitive/addMore', 0, '', '敏感词过滤', 0, '', ''),
(271,'新增、编辑敏感词', 268, 0, 'Sensitive/edit', 1, '', '', 0, '', ''),
(272,'设置敏感词状态', 268, 0, 'Sensitive/setStatus', 1, '', '', 0, '', ''),
(273, '自定义表情列表', 74, 0, 'Expression/iexpressionList', 0, '', '表情设置', 0, '', ''),
(274, '允许身份访问', 116, 0, 'Role/moduleRole', 0, '', '模块权限', 0, '', ''),
