...
require_once('encoding/pb_base128.php');
require_once('type/pb_scalar.php');
require_once('type/pb_enum.php');
require_once('type/pb_bytes.php');
require_once('type/pb_string.php');
require_once('type/pb_int.php');
require_once('type/pb_bool.php');
require_once('type/pb_signed_int.php');
require_once('reader/pb_input_reader.php');
require_once('reader/pb_input_string_reader.php');
/**
