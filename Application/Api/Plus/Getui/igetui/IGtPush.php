...
require_once(dirname(__FILE__).'/' . '../protobuf/pbmessage.php');
require_once('IGtReq.php');
require_once('IGtMessage.php');
require_once('IGtAppMessage.php');
require_once('IGtListMessage.php');
require_once('IGtSingleMessage.php');
require_once('IGtTarget.php');
require_once('template/IGtBaseTemplate.php');
require_once('template/IGtLinkTemplate.php');
require_once('template/IGtNotificationTemplate.php');
require_once('template/IGtTransmissionTemplate.php');
require_once('template/IGtNotyPopLoadTemplate.php');
require_once('template/IGtAPNTemplate.php');
require_once('utils/GTConfig.php');
require_once('utils/HttpManager.php');
require_once('utils/ApiUrlRespectUtils.php');
require_once('utils/LangUtils.php');
