...
<script>
    ...
    <link type="text/css" rel="stylesheet" href="/shanren/Application/Question/Static/css/index.css"/>
    <style>
        #main-container {
            margin-top: 70px;
        }
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            <div class="modal-content qtDialog">
                ...
                <div class="haveNo">
                    <span>没有符合？</span>
                    <a href="<?php echo U('Question/Index/edit');?>" class="qtAsk">提问</a>
                </div>
            </div>
        </div>
    </div>
    <div class="qtWrap">
        <div class="qtLeft">
            <div class="qtTop">
                ...
                <ul class="qtHot">
                    <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('questions',array('category'=>$data['id']));?>"><?php echo ($data["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li class="qtOne">
        <div class="left">
            ...
            <div class="info">
                <p><span>问：</span><span class="qtTitle"><a target="_blank" href="<?php echo U('Question/Index/detail',array('id'=>$data['id']));?>"><?php echo ($data["title"]); ?></a></span><span class="state">
        ...
        <div class="right">
            <p class="offer">悬赏：<?php echo ($data["score_num"]); ?></p>
            <p><i class="icon-time"></i><span><?php echo (friendlydate($data["create_time"])); ?></span></p>
        </div>
    </li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
            ...
            <div class="qtCard" style="display: none">
                ...
                <div class="cdBottom">
                    <div class="btBox asked">
                        <a href="<?php echo U('index',array('type'=>'my','types'=>q));?>"><p style="color: #ffffff;"><?php echo ($my_ask); ?></p></a>
                        <p>我的提问</p>
                    </div>
                    <div class="btBox answered">
                        <a href="<?php echo U('index',array('type'=>'my','types'=>a));?>"><p style="color: #ffffff;"><?php echo ($my_help); ?></p></a>
                        <p>我的回答</p>
                    </div>
                </div>
            </div>
