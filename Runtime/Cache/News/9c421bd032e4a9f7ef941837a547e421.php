...
<script>
    ...
    <link type="text/css" rel="stylesheet" href="/shanren/Application/News/Static/css/news.css"/>
...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div class="row">
            ...
            <div class="common_block_border">
                ...
                <div class="common_block_title clearfix">
                    <?php if($info['cover'] != 0): ?><div class="col-xs-4" >
                        ...
                        <div class="col-xs-4" >
                            <a title="<?php echo (op_t($info["title"])); ?>" href="<?php echo U('News/index/detail',array('id'=>$info['id']));?>">
                                <img alt="暂无封面" src="/shanren/Application/News/Static/images/nopicture.jpg" style="width: 200px;height: 146px">
                            </a>
                        </div>
                        <div class="col-xs-8" >
                            <h2><?php echo ($info["title"]); ?></h2>
        ...
        <div class="col-xs-4" >
            ...
            <?php echo W('Common/Adv/render',array(array('name'=>'news_right_below_all','type'=>1,'width'=>'360px','height'=>'100px','title'=>'资讯右侧下方广告')));?>
        </div>
    </div>


    </div>
    <script type="text/javascript" charset="utf-8" src="/shanren/Public/static/ueditor/third-party/SyntaxHighlighter/shCore.js"></script>
    <link rel="stylesheet" type="text/css" href="/shanren/Public/static/ueditor/third-party/SyntaxHighlighter/shCoreDefault.css"/>
    <script type="text/javascript">
